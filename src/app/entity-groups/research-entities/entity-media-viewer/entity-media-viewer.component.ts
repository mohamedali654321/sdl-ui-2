...
@Component({
  selector: 'ds-entity-media-viewer',
  templateUrl: './entity-media-viewer.component.html',
  styleUrls: ['./entity-media-viewer.component.scss'],
})
export class EntityMediaViewerComponent implements OnInit {
  @Input() item: Item;

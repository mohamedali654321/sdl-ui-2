 ...
 */
@Component({
  selector: 'ds-entity-media-viewer-image',
  templateUrl: './entity-media-viewer-image.component.html',
  styleUrls: ['./entity-media-viewer-image.component.scss'],
})
export class EntityMediaViewerImageComponent implements OnInit {
